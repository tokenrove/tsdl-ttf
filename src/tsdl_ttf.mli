...
val byte_swapped_unicode : int -> unit
...
val render_text_solid :
  font -> string -> color -> Tsdl.Sdl.surface option
val render_utf8_solid :
  font -> string -> color -> Tsdl.Sdl.surface option
val render_unicode_solid :
  font ->
  Unsigned.uint16 Ctypes_static.ptr -> color -> Tsdl.Sdl.surface option
val render_glyph_solid :
  font ->
  Unsigned.uint16 -> color -> Tsdl.Sdl.surface option
val render_text_shaded :
  font ->
  string -> color -> color -> Tsdl.Sdl.surface option
val render_utf8_shaded :
  font ->
  string -> color -> color -> Tsdl.Sdl.surface option
val render_unicode_shaded :
  font ->
  Unsigned.uint16 Ctypes_static.ptr ->
  color -> color -> Tsdl.Sdl.surface option
val render_glyph_shaded :
  font ->
  Unsigned.uint16 -> color -> color -> Tsdl.Sdl.surface option
val render_text_blended :
  font ->
  string -> color -> Tsdl.Sdl.surface option
...
val render_text_blended_wrapped :
  font ->
  string -> color -> Unsigned.uint32 -> Tsdl.Sdl.surface option
val render_utf8_blended_wrapped :
  font ->
  string -> color -> Unsigned.uint32 -> Tsdl.Sdl.surface option
val render_unicode_blended_wrapped :
  font ->
  Unsigned.uint16 Ctypes_static.ptr ->
  color -> Unsigned.uint32 -> Tsdl.Sdl.surface option
